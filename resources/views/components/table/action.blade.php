...
$themeClasses = match($type) {
    'edit' => 'bg-amber-50 text-amber-700 border-amber-200/80 hover:bg-amber-500 hover:text-white hover:border-amber-500 dark:bg-amber-950/40 dark:text-amber-300 dark:border-amber-800/60 dark:hover:bg-amber-500 dark:hover:text-white focus:ring-amber-500',
