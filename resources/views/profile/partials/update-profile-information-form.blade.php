            ...
            <div class="mt-2 flex items-center gap-5">
                ...
                <div class="relative shrink-0">
                    <template x-if="photoPreview">
                        <img :src="photoPreview" alt="{{ $user->name }}" class="w-20 h-20 rounded-full object-cover ring-4 ring-orange-100 dark:ring-orange-950/60 shadow-md">
                    </template>
                    <template x-if="!photoPreview">
                        <div class="w-20 h-20 rounded-full bg-gradient-to-tr from-orange-500 to-amber-500 text-white font-bold text-2xl flex items-center justify-center ring-4 ring-orange-100 dark:ring-orange-950/60 shadow-md">
                ...
                <!-- Actions & Info -->
                <div class="space-y-2">
                    <input type="file" x-ref="photoInput" name="photo" @change="previewImage" accept="image/png,image/jpeg,image/jpg,image/webp,image/gif" class="hidden">
                    <input type="hidden" name="remove_photo" :value="removePhoto ? '1' : '0'">

                    <div class="flex items-center gap-3 flex-wrap">
                        <x-secondary-button type="button" @click="$refs.photoInput.click()" class="text-xs">
                        ...
                        <button type="button" x-show="hasPhoto" @click="clearPhoto" class="inline-flex items-center text-xs font-semibold text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 transition">
