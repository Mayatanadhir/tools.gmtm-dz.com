                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        ...
                        <div class="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm border border-gray-100 dark:border-gray-700/60 transition-all duration-200 hover:shadow-md">
                            ...
                            <div class="mt-4 border-t border-gray-100 dark:border-gray-700/60 pt-3">
                                <a href="{{ route('system-tables.users') }}" class="inline-flex items-center text-xs font-semibold text-orange-600 dark:text-orange-400 hover:underline">
                        ...
                        <div class="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm border border-gray-100 dark:border-gray-700/60 transition-all duration-200 hover:shadow-md">
                            ...
                            <div class="mt-4 border-t border-gray-100 dark:border-gray-700/60 pt-3">
                                <a href="{{ route('system-tables.roles') }}" class="inline-flex items-center text-xs font-semibold text-orange-600 dark:text-orange-400 hover:underline">
                                    <span>{{ __('Details') }}</span> &rarr;
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm border border-gray-100 dark:border-gray-700/60 transition-all duration-200 hover:shadow-md">
                            ...
                            <div class="mt-4 border-t border-gray-100 dark:border-gray-700/60 pt-3">
                                <a href="{{ route('system-tables.activity-log') }}" class="inline-flex items-center text-xs font-semibold text-orange-600 dark:text-orange-400 hover:underline">
                                    <span>{{ __('Details') }}</span> &rarr;
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm border border-gray-100 dark:border-gray-700/60 transition-all duration-200 hover:shadow-md">
                            ...
                            <div class="mt-4 border-t border-gray-100 dark:border-gray-700/60 pt-3">
                                <a href="{{ route('system-tables.queues') }}" class="inline-flex items-center text-xs font-semibold text-orange-600 dark:text-orange-400 hover:underline">
                                    <span>{{ __('Details') }}</span> &rarr;
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        ...
                        <div class="xl:col-span-1 rounded-xl bg-white dark:bg-gray-800 p-6 shadow-sm border border-gray-100 dark:border-gray-700/60">
                            ...
                            <div class="space-y-3">
                                ...
                                @foreach($schemaItems as $item)
                                    <a href="{{ $item['route'] }}" class="flex items-center justify-between p-2.5 rounded-lg bg-gray-50 dark:bg-gray-700/40 hover:bg-orange-500/10 dark:hover:bg-orange-500/15 transition-colors group">
                                        <span class="font-mono text-xs font-semibold text-gray-800 dark:text-gray-200 group-hover:text-orange-600 dark:group-hover:text-orange-400">
                                            {{ $item['name'] }}
                                        </span>
                        ...
                        <div class="xl:col-span-2 rounded-xl bg-white dark:bg-gray-800 p-6 shadow-sm border border-gray-100 dark:border-gray-700/60">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="{{ route('system-tables.activity-log') }}" class="text-xs font-semibold text-orange-600 dark:text-orange-400 hover:underline">
